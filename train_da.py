...
from utils import encode, remove_random_symbols, Trainer
...
for artist in artists:
    ...
    ## データ拡張 ##
    df_aug = df_artist.copy()
    df_aug['block'] = df_aug['block'].apply(remove_random_symbols, args=(0.5,))
    df_artist = pd.concat([df_artist, df_aug]).drop_duplicates()
    ################
